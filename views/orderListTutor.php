...
<head>
    ...
    <style>
        ...
        .label-wait,
        .status-badge.label-wait {
            background-color: #fd7e14;
            color: white;
        }

        .label-reject,
        .status-badge.label-reject {
            background-color: #6c757d;
            color: white;
        }

        .label-proses,
        .status-badge.label-proses {
            background-color: #0d6efd;
            color: white;
        }

        .label-pending,
        .status-badge.label-pending {
            background-color: #ffc107;
            color: #212529;
        }

        .label-done,
        .status-badge.label-done {
    ...
    <body class="montserratRegular">
        ...
        <div class="navbar w-100">
            <div class="container-fluid row px-5">
                <div class="col-auto float-start ps-4">
