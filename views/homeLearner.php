            ...
            <?php foreach ($datas as $data) : ?>
                <div class="card col-6 p-4 shadow-lg p-3 bg-white rounded">
                    ...
                    <a href="classDetail.php?id=<?php echo $id; ?>&classId=<?php echo $data['idKelas']; ?>" style="color: inherit; text-decoration: none;">
                        <img class="card-img-top py-3" src="../images/<?php echo $data['fotoKelas']; ?>" alt="Card image cap"style="height: 200px; width: 100%; object-fit: cover;">
                        <div class="card-body">
                            ...
                            <p class="card-text montserratSemiBold" style="font-size: 30px;">Rp. <?php echo $data['hargaKelas']; ?></p>
